...
class RetinaNetModule(L.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('val_map_step', self.metric, on_step=False, on_epoch=True, prog_bar=True, logger=True)
    ...
    def test_step(self, batch, batch_idx):
        ...
        preds = self.model(images, targets)
        self.metric(preds, targets)
        self.log('test_map_step', self.metric, on_step=False, on_epoch=True, prog_bar=True, logger=True)
